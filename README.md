...
- uses: sealance-io/setup-leo-action@<SHA>
  with:
    version: '4.4.2'
    rust-version: '1.96.0'  # Leo v4.4.2 minimum
```
...
|-------|----------|---------|-------------|
| `version` | **Yes** | - | Leo version without `v` prefix (e.g., `4.4.2`) |
...
Example: leo-binary-v4.4.2-linux-x86_64
```
...
Example: leo-cargo-v4.4.2-1.96.0-linux-x86_64
```
...
```
main branch
├── Creates: leo-binary-v4.4.2-linux-x86_64
├── Creates: leo-cargo-v4.4.2-1.96.0-linux-x86_64
│
...
**Solutions**:
1. Verify the source tag exists: `./scripts/verify-release.sh 4.4.2`
